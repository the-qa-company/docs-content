...
To upload a new dataset you can use one of the following code snippets (remember to use the Bearer Token that you get at Signin [Signup and login](register-login)):
