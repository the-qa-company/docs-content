...
<div style={{ display: 'flex', alignItems: 'center', flexDirection: 'column', gap: '10px', marginBottom: '20px' }}>
    <img src='/img/newUI/premise-mode/admin-navbar.png' alt='training button' width= '30%'/>
</div>

The admin page contains a list of all users:

<Image src='/img/newUI/premise-mode/admin-table-start.png' alt='table start'/>
<Image src='/img/newUI/premise-mode/admin-table-end.png' alt='table end'/>
...
<Image src='/img/newUI/premise-mode/admin-add-user.png' alt='admin page add user' />
...
<Image src='/img/newUI/premise-mode/admin-change-pwd.png' alt='admin page change pwd' />
...
<Image src='/img/newUI/premise-mode/admin-delete-user.png' alt='admin page delete user' />
