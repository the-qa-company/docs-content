...
<p style={{  display: 'flex', flexWrap: 'wrap', alignItems: 'center' }}>
    <span>You can click on the "SPARQL interpretation" icon:</span>
    <img src='/img/icons/change_circle.svg' style={{ width: '30px', padding: '0 5px' }}/>
    <span>(at the left of the current interpretation)</span><span> all generated interpretations will be shown:</span>
</p>
...
On this page you have an overview of how the system performs on the questions you gave feedbacks and some statistics.
