...
<Image src='/img/newUI/playground-graph/where-born-wrong-interpretation.png' alt='where are you born' />
...
<div style={{ display: 'flex', alignItems: 'center', gap: '30px', marginBottom: '20px', justifyContent: 'center' }}>
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
        <img src='/img/newUI/playground-graph/born-at-interpretations-btn.png' alt='show more interpretations' width='200px'/>
        Click to show more interpretations
    </div>
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
        <img src='/img/newUI/playground-graph/born-at-interpretations-open.png' alt='hide interpretations' width='200px'/>
        Click to hide interpretations
    </div>
</div>
I found the right interpretation:

<Image src='/img/newUI/playground-graph/where-born-sparql-interpretations.png' alt='interpretations' />

You see it, it is the 2nd one! When I clicked on it I got the right answer:

<Image src='/img/newUI/playground-graph/where-born.png' alt='where are you born' />
...
<div>
    ...
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '20px' }}>
        <img src='/img/newUI/playground-graph/download-playground.png' alt='download' width='200px'/>
    </div>
