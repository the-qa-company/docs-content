...
<Tabs>
  <TabItem value='q1' label='Question 1' default>
      <Image src='/img/newUI/playground-graph/what-language-qanswer-speaks.png' alt='what languages does QAnswer speak'/>
  </TabItem>

  <TabItem value="q2" label="Question 2">
      <Image src='/img/newUI/playground-graph/qanswer-speaks.png' alt='QAnswer speaks'/>
  </TabItem>

  <TabItem value='q3' label='Question 3'>
      <Image src='/img/newUI/playground-graph/who-speaks-french.png' alt='who speaks french?'/>
  </TabItem>

  <TabItem value='q4' label='Question 4'>
    <Image src='/img/newUI/playground-graph/how-many-languages-qanswer-speak.png' alt='how many languages does QAnswer speak'/>
  </TabItem>
</Tabs>
