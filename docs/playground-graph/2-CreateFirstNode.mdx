...
<TabItem value='ui' label='UI'>
  ...
  <Image src='/img/newUI/playground-graph/first-node.png' alt='First node'/>
...
<Image src='/img/newUI/playground-graph/what-is-qanswer.png' alt='QAnswer?'/>
...
<Image src='/img/newUI/playground-graph/what-is-qa.png' alt='QA?'/>
...
<TabItem value='ui' label='UI'>
  ...
  <Image src='/img/newUI/playground-graph/who-are-you.png' alt='skos:altLabel "you"'/>
