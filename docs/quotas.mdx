...
<Tabs>
  <TabItem value='b1' label='Add files'>
    <Image src='/img/newUI/tuto-ui-text/add-dataset-upload.png' alt='create a text QA System: upload page'/>
  </TabItem>
  
  <TabItem value='b2' label='Exceeded quota'>
    <Image src='/img/newUI/quotas-exceeded.png' alt='collection too big'/>
  </TabItem>
</Tabs>