...
<ImageGrid
    images={[
        {
            src: '/img/screenshots/tuto-ui-graph/status-bar.png',
            alt: 'training button',
        }, {
            src: '/img/screenshots/tuto-ui-graph/qa-system-training-btn.png',
            alt: 'training button',
        }
    ]}
    noTransformation
...
More information about sharing can be found [here](/tutorial-ui/rdf-based/share).
...
<Image src='/img/screenshots/tuto-ui-graph/filter-menu.png' alt='nav bar' width='180px' centered />
