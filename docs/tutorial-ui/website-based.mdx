...
<Image src='/img/screenshots/tutorial-ui-website/website-empty.png' alt='Empty wizard'/>
...
<Tabs>
    <TabItem value='input' label='Input'>
        <Image src='/img/screenshots/tutorial-ui-website/website-first-input.png' alt='Add first link'/>
    </TabItem>
    <TabItem value='added' label='Added' default>
        <Image src='/img/screenshots/tutorial-ui-website/website-first-add.png' alt='Add first link'/>
    </TabItem>
</Tabs>
...
<Tabs>
    <TabItem value='g1' label='Group sub-pages'>
        <Image src='/img/screenshots/tutorial-ui-website/website-after-extract.png' alt='Grouped sub-pages'/>
    </TabItem>
    <TabItem value='s1' label='Show sub-pages' default>
        <Image src='/img/screenshots/tutorial-ui-website/website-show-extracted.png' alt='Show sub-pages'/>
    </TabItem>
</Tabs>
...
<Image src='/img/screenshots/tutorial-ui-website/website-remove.png' alt='Remove'/>
...
<Tabs>
    <TabItem value='g1' label='Before' default>
        <Image src='/img/screenshots/tutorial-ui-website/website-move-sub-url.png' alt='before moving'/>
    </TabItem>
    <TabItem value='s1' label='After'>
        <Image src='/img/screenshots/tutorial-ui-website/website-after-moving-sub-url.png' alt='after moving'/>
    </TabItem>
</Tabs>
