...
<Image src='/img/newUI/tuto-ui-graph/autocompletion.png' />
...
<Image src='/img/newUI/tuto-ui-graph/margaglass.png' />
...
<Image src='/img/newUI/tuto-ui-graph/autocompletion-image.png' />

Similarly if you specify a property that is used to disambiguate entities you will get autosugestions like:

<Image src='/img/newUI/tuto-ui-graph/autocompletion-disambiguation.png' />
...
<Image src='/img/newUI/tuto-ui-graph/sparql.png' />
...
<Image src='/img/newUI/tuto-ui-graph/interpretation-margarita.png' />

or to facilitate the understanding of the generated interpretations:

<Image src='/img/newUI/tuto-ui-graph/interpretation-other.png' />
