...
:::info
In this tutorial we are going to make a Question Answering (QA) system on top of a cocktail KB that can be found here:
...
<Image src='/img/newUI/tuto-ui-graph/margarita-facet-short.png' alt='margarita'/>

and

<Image src='/img/newUI/tuto-ui-graph/cocktails-image-short.png' alt='all cocktails' />
