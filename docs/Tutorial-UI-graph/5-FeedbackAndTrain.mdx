...
<Image src='/img/newUI/tuto-ui-graph/what-is-a-cocktail.png' alt='wrong answer'/>
...
<Image src='/img/newUI/tuto-ui-graph/what-is-a-cocktail-sparqllist.png' alt='SPARQL list'/>
...
<Image src='/img/newUI/tuto-ui-graph/cocktail.png' alt='right answer'/>
...
<div style={{ display: 'flex', alignItems: 'center', flexDirection: 'column', gap: '10px', marginBottom: '20px' }}>
    <img src='/img/newUI/tuto-ui-graph/status-bar.png' alt='training button' width= '60%'/>
    <img src='/img/newUI/tuto-ui-graph/qa-system-training-btn.png' alt='training button' width= '60%'/>
</div>
...
<Tabs>
  <TabItem value="q2" label="No feedbacks yet">
    <Image src='/img/newUI/tuto-ui-graph/training-empty.png' alt='new feedbacks'/>
  </TabItem>

  <TabItem value='q1' label='You already have some feedbacks' default>
    <Image src='/img/newUI/tuto-ui-graph/training-existing.png' alt='existing feedbacks'/>
  </TabItem>
</Tabs>
...
<Image src='/img/newUI/tuto-ui-graph/training-upload-done.png' alt='before training'/>

After clicking on *Train* the system will create a model that adapts to your dataset:

<Image src='/img/newUI/tuto-ui-graph/trained.png' alt='after training' />
...
<Image src='/img/newUI/tuto-ui-graph/logs.png' alt='logs' />
...
<Image src='/img/newUI/tuto-ui-graph/share.png' alt='share' />
...
<Tabs>
  <TabItem value='f' label='Feedbacks'>
    <Image src='/img/newUI/tuto-ui-graph/feedbacks-shared.png' alt='feedbacks'/>
  </TabItem>

  <TabItem value='l' label='Logs' default>
    <Image src='/img/newUI/tuto-ui-graph/logs-shared.png' alt='logs'/>
  </TabItem>
</Tabs>
...
<div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px', justifyContent: 'center' }}>
    <img src='/img/newUI/tuto-ui-graph/filter-menu.png' alt='nav bar' style={{ height: '300px' }}/>
</div>

Let's use the *Filter* option to filter the feedbacks by user.

<Image src='/img/newUI/tuto-ui-graph/filtered-user.png' alt='filter by username'/>

You can filter in various ways and adapt the filters to your needs.

<Image src='/img/newUI/tuto-ui-graph/filter-option.png' alt='filter by username'/>