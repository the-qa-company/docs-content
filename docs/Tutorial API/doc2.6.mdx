...
Up to now the result was always given by the URI and "rdfs:label". But in an RDF dataset there are potentially many contextual information that can be shown like
