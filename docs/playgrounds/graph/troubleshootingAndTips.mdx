...
<div style={{ display: 'flex', alignItems: 'center', gap: '30px', marginBottom: '20px', justifyContent: 'center' }}>
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
        <img src='/img/screenshots/playground-graph/born-at-interpretations-btn.png' alt='show more interpretations' width='200px'/>
        Click to show more interpretations
    </div>
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
        <img src='/img/screenshots/playground-graph/born-at-interpretations-open.png' alt='hide interpretations' width='200px'/>
...
Let's see now how to construct a full [QA System over an RDF Graph!](/tutorial-ui-graph/rdf-to-qa)