...
QAnswer is a Question Answering platform, i.e., a platform that allows to find answers accross your data. You can query several data sources, such as **RDF data** or even a **collection of documents** (txt, pdf, docx, ...). It makes your data accessible via natural language!
