...
You can access it using the button in the status bar (on top of your screen) or in the **QA Systems** page by clicking on the QA system you are interested in and then the *Training* button.
