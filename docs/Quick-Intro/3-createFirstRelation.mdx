...
<Tabs>
  <TabItem value='q1' label='Question 1' default>
      <Image src='/img/newUI/question-1.png' alt='what languages does QAnswer speak'/>
  </TabItem>

  <TabItem value="q2" label="Question 2">
      <Image src='/img/newUI/question-2.png' alt='QAnswer speaks'/>
  </TabItem>

  <TabItem value='q3' label='Question 3'>
      <Image src='/img/newUI/question-3.png' alt='who speaks french?'/>
  </TabItem>

  <TabItem value='q4' label='Question 4'>
    <Image src='/img/newUI/question-4.png' alt='how many languages does QAnswer speak'/>
  </TabItem>
</Tabs>
