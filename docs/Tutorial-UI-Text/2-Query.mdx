...
<Image src='/img/newUI/tuto-ui-text/qa-system-selector.png' alt='ask page'/>
...
<Tabs>
  <TabItem value='q1' label='Question 1' default>
    <Image src='/img/newUI/tuto-ui-text/who-are-the-children.png' alt='who are the children of the simpsons'/>
  </TabItem>

  <TabItem value="q2" label="Question 2">
    <Image src='/img/newUI/tuto-ui-text/what-is-name-of-dog.png' alt='what is the name of the dog of the simpsons'/>
  </TabItem>
</Tabs>
