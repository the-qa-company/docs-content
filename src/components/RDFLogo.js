export default function RDFLogo (props) {
  const { color, color2, size } = props
  return (
    <svg
      version='1.1'
      overflow='visible'
      viewBox='0 0 410 409.99999'
      id='svg214'
      width={size ?? '100'}
      height={size ?? '100'}
    ...
    >
      <g
        ...
        id='g212'
        transform='translate(-102.37775,1.6383025e-4)'
      >
        <g
          id='g437'
          transform='translate(56.702917)'
        >
          <g
            id='g431'
            transform='translate(16.337497)'
          >
            <path
